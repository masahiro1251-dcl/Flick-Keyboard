...
namespace Microsoft.MixedReality.Toolkit.UI
{
    ...
    public class MyPressableButton : MonoBehaviour, IMixedRealityTouchHandler
    {
        ...
        private float GetFarthestDistanceAlongPressDirection()
        {
            ...
            foreach (var touchEntry in touchPoints)
            {
                ...
                if (testDistance > farthestDistance)
                {
                    ...
                    recentTouchedPoint = getLocalPosition(touchEntry.Value);
                }
            }
